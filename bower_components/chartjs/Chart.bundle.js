...
module.exports = function(Chart) {
	...
	Chart.elements.Point = Chart.Element.extend({
		...
		draw: function() {
			...
			var chartOpts = this._chart.config.options;
			
			if (chartOpts.datalabels) {
				var value = this._chart.config.data.datasets[this._datasetIndex].data[this._index];
				renderDatalabel(ctx, value, x + 15, y - 3);
...
module.exports = function(Chart) {
	...
	Chart.elements.Rectangle = Chart.Element.extend({
		draw: function() {
			...
			if (chartOpts.datalabels) {
				var value = this._chart.config.data.datasets[this._datasetIndex].data[this._index];
				renderDatalabel(ctx, value, vm.x, vm.y - 5);
			}
...
/**
 * @author kranti.chavannavar
 * 
 * Customized the plugin to add datapoint label for line and bar charts.
 * 
 ...
 * @param y posioion y
 */
function renderDatalabel(ctx, value, x, y) {
	ctx.textAlign = 'center';
    ctx.textBaseline = 'bottom';
    ctx.fillStyle = 'black';
